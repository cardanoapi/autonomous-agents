...
.. code-block:: bash
    ...
    Commands:
      serve  backend CLI serve command.
    $ backend serve --help
    Usage: backend serve [OPTIONS]
...
.. code-block:: bash
    ...
    $ make image
    $ podman run -dit --name backend -p 8000:8000 backend:$(cat TAG)
    f41e5fa7ffd512aea8f1aad1c12157bf1e66f961aeb707f51993e9ac343f7a4b
    $ podman ps
    CONTAINER ID  IMAGE                                 COMMAND               CREATED        STATUS            PORTS                   NAMES
    f41e5fa7ffd5  localhost/backend:0.1.0  /usr/bin/fastapi ...  2 seconds ago  Up 3 seconds ago  0.0.0.0:8000->8000/tcp  backend
    $ curl localhost:8000/api/ready
    {"status":"ok"}
