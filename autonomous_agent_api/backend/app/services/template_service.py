...
class TemplateService:
    def __init__(self, template_repository: TemplateRepository, template_trigger_repository: TemplateTriggerRepository):
    ...
    async def create_template(self, template_data):
        ...
        if template_triggers:
            for trigger_data in template_triggers:
                template_trigger_response = await self.template_trigger_repository.save_template_trigger(
