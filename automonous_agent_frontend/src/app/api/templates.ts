"use client"
import { ITemplateOption, templateFormSchema } from '../(pages)/templates/create-template/page';
...
export const postTemplateData = async (formData: z.infer<typeof templateFormSchema>) => {
    ...
    try {
        const response = await axios.post(`${baseAPIurl}/templates/`, formatedTemplatedata, {
            headers: {
