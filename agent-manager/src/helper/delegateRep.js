...
exports.checkDrepStatus = void 0;
const runCheckUntil400 = async (kuberUrl, apiUrl, agent_id, api_key) => {
        ...
        if (response.ok) {
            ...
            if (contentType && contentType.includes('application/json')) {
                ...
                if (errorData.message && errorData.message.includes("ConwayDRepAlreadyRegistered")) {
                    ...
                    return { status: 400, data: { registered: true, balance: true } };
                }
...
const checkDrepStatus = async (kuberUrl, apiUrl, agent_id, api_key) => {
...
exports.checkDrepStatus = checkDrepStatus;
