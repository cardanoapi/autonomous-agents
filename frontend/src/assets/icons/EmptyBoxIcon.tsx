...
const EmptyBoxIcon = () => (
  ...
  >
    ...
    <path
      ...
      fill="#0033AD"
    />
    <path d="M510.4 179.2l324.8 196v354.4L510.4 554.4z" fill="#0C50B4" />
    <path d="M510.4 179.2L180.8 375.2v354.4l329.6-175.2z" fill="#0C50B4" />
    <path
    ...
    <path
      ...
      fill="#0033AD"
    />
    <path d="M510.4 550.4L372 496 180.8 374.4v355.2l329.6 196 324.8-196V374.4L688.8 483.2z" fill="#1C63E71F" />
    <path
      ...
      fill="#0033AD"
    />
    <path d="M510.4 925.6l324.8-196V374.4L665.6 495.2l-155.2 55.2z" fill="#0C50B4" />
    <path d="M510.4 933.6c-1.6 0-2.4 0-4-0.8-2.4-1.6-4-4-4-7.2V550.4c0-3.2 2.4-6.4 5.6-7.2L662.4 488l168-120c2.4-1.6 5.6-1.6 8-0.8 2.4 1.6 4 4 4 7.2v355.2c0 3.2-1.6 5.6-4 7.2l-324.8 196s-1.6 0.8-3.2 0.8z m8-377.6v355.2l308.8-185.6V390.4L670.4 501.6c-0.8 0.8-1.6 0.8-1.6 0.8l-150.4 53.6z"
      fill="#0033AD"
    />
    <path d="M252.8 604l257.6 145.6V550.4l-147.2-49.6-182.4-126.4z" fill="#0C50B4" />
    <path d="M32 460l148.8-85.6 329.6 176L352 640.8z" fill="#FFFFFF" />
    <path d="M659.2 693.6l176-90.4V375.2L692 480.8l-179.2 68-2.4 0.8z" fill="#FFFFFF" />
  </svg>
);
