...
function TemplateCardContent({
    ...
    return (
        <Card
            className="hover-transition-primary group relative flex h-[137px] xl:max-w-[271px] 3xl:max-w-none w-full flex-col justify-between gap-y-2 px-4 py-3 hover:cursor-pointer"
            onClick={onEdit}
        >
            <div>
                <TemplateCardHeader
