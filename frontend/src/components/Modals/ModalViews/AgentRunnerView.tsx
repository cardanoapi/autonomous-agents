...
const AgentRunnerModalView = ({
    ...
    const dockerCommand = `docker run --pull always -e WS_URL=${environments.NEXT_PUBLIC_WS_URL} -e AGENT_ID=${agentId} cardanoapi/autonomous-agents-agent-node:${environments.NEXT_PUBLIC_IMAGE_TAG}`;
