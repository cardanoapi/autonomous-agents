...
import { TypographyH2 } from '@app/components/atoms/typography';
import AppDialog from '@app/components/molecules/AppDialog';
import AgentAvatar from '../agent/AgentAvatar';
import { cn } from '@app/components/shadcn/lib/utils';
import { Skeleton } from '@app/components/shadcn/ui/skeleton';

import AgentsDelegationDialogContent from '../../../app/(pages)/dRep-directory/components/AgentsDelegationDialogContent';
import DrepDetailDialogContent from '../../../app/(pages)/dRep-directory/components/DrepDetailDialogContent';
