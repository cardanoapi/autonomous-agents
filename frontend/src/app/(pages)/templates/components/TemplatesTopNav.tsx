...
const TemplatesTopNav = ({ onSearch, adminAccess }: { onSearch: any; adminAccess: boolean }) => {
    return (
        <div className="flex justify-between gap-x-4 gap-y-2">
            <div className="flex items-center justify-center ">
                <DataActionBar className="h-10" placeholder="Search Template Name " onSearch={onSearch} />
            </div>
