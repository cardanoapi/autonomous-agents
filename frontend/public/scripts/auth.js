!function() {
  var t = {
    816: function(t, e, n) {
      ...
      !function(o, s) {
        "use strict";
        i = [n(170)], void 0 === (a = "function" == typeof (r = function(t) {
            ...
            parse: function(t) {
              ...
              return i(a(e.stack.split("\n"), (function(t) {
                ...
                var n = e.replace(/^\s+/, "").replace(/\(eval code/g, "(").split(/\s+/).slice(1),
                  r = this.extractLocation(n.pop()), i = n.join(" ") || void 0, a = function(t, e) {
              ...
              return i(a(e.stack.split("\n"), (function(t) {
                ...
                var n = e.split("@"), r = this.extractLocation(n.pop()), i = n.join("@") || void 0;
              ...
              return i(a(n.stack.split("\n"), (function(t) {
                ...
                var n, r = e.split("@"), i = this.extractLocation(r.pop()), a = r.shift() || "",
      ...
      !function(a, o) {
        ...
        r = [], void 0 === (i = "function" == typeof (n = function() {
          ...
          function e(t, e, n, r, i, a) {
            void 0 !== t && this.setFunctionName(t), void 0 !== e && this.setArgs(e), void 0 !== n && this.setFileName(n), void 0 !== r && this.setLineNumber(r), void 0 !== i && this.setColumnNumber(i), void 0 !== a && this.setSource(a);
          }
  ...
  n.n = function(t) {
    ...
    var v = "Promise" in p ? p.Promise : l, h = [].slice, g = "undefined" != typeof window,
    ...
    function b(t) {
      return function(t) {
        ...
        return e.join("");
      }("undefined" != typeof crypto && "function" == typeof crypto.getRandomValues ? crypto.getRandomValues(_) : "undefined" != typeof msCrypto && "function" == typeof msCrypto.getRandomValues ? msCrypto.getRandomValues(_) : _).substr(0, t);
    }
    ...
    function E() {
      return g && "function" == typeof Set && "function" == typeof JSON.stringify && m && "function" == typeof m.now && "withCredentials" in new window.XMLHttpRequest;
    }

    function x(t, e, n) {
      if (n && t) {
        var r = q(t), i = typeof e;
    ...
    function C(t, e, n) {
      for (var r = 0, i = e.length; r < i; ++r) {
        var a = e[r];
        if (I(a) || "function" == typeof a) for (var o = Object.keys(a), s = 0, c = o.length; s < c; s++) {
          var u = o[s], f = a[u];
    ...
    function L() {
      if ("undefined" != typeof document) {
        ...
        return t || function() {
          if ("undefined" != typeof document) for (var t = document.getElementsByTagName("script"), e = 0, n = t.length; e < n; e++) {
            var r = t[e];
    ...
    function J(t, e, n) {
      ...
      if (r && !(i = r[c])) {
        ...
        if (!(s = u) || !1 !== s.writable && ("function" != typeof s.get || void 0 !== s.set)) {
          ...
          }, a = r[e], o = i, a[$("OriginalDelegate")] = o;
        }
      }
      return i;
    }

    var X = $("xhrIgnore"), G = $("xhrSync"), Z = $("xhrURL"), Y = $("xhrMethod"), Q = "invoke",
      W = ["link", "css", "script", "img", "xmlhttprequest", "fetch", "beacon", "iframe"], K = "page-load",
      tt = [K, "route-change", "user-interaction", "http-request", "custom", "temporary"];

    function et(t) {
      var e = XMLHttpRequest.prototype;
      if (e && e.addEventListener) var n = J(e, "open", (function() {
        return function(t, e) {
    ...
    var ot = function() {
      ...
      return e.observe = function(t, e) {
        var n = this;
        if ("function" == typeof e) return this.observers[t] || (this.observers[t] = []), this.observers[t].push(e), function() {
    ...
    function ut() {
      return ct || (ct = !0, et((function(t, e) {
        st.send("xmlhttprequest", [t, e]);
      })), function(t) {
        if (at()) {
          var e = window.fetch;
          window.fetch = function(t, o) {
            var s, c, u = this, f = arguments, d = t instanceof URL;
            if ("string" == typeof t || d) s = new Request(t, o), c = d ? s.url : t; else {
        ...
        function i(t, e) {
          ...
          }(e), t.data.error = e, r(t);
        }

        function a(t, e) {
          var n = t.getReader();
          !function t() {
            n.read().then((function(n) {
              n.done ? r(e) : t();
            }), (function(t) {
              i(e, t);
            }));
    ...
    var ft = { bootstrapTime: null, lastHiddenStart: Number.MIN_SAFE_INTEGER }, dt = !1;

    function lt() {
      return E() ? (ut(), ft.bootstrapTime = A(), dt = !0) : g && console.log("[Elastic APM] platform is not supported!"), dt;
    }

    function pt(t, e) {
      var n = e.error, r = e.filename, i = e.lineno, a = e.colno, o = [];
      if (n) try {
        o = t.parse(n);
      } catch (t) {
      }
      return function(t) {
      ...
      }(o) || (o = [{ fileName: r, lineNumber: i, columnNumber: a }]), o.map((function(t) {
        return t.functionName && (t.functionName = (e = t.functionName, n = e.split("/"), e = (e = (e = n.length > 1 ? ["Object", n[n.length - 1]].join(".") : n[0]).replace(/.<$/gi, ".<anonymous>")).replace(/^Anonymous function$/, "<anonymous>"), e = (n = e.split(".")).length > 1 ? n[n.length - 1] : n[0])), t;
        var e, n;
      })).map((function(t) {
        var e = t.fileName, n = t.lineNumber, r = t.columnNumber, i = t.functionName,
        ...
        var o, s, c = function(t) {
          ...
          u = (o = c, s = window.location.origin || window.location.protocol + "//" + window.location.hostname + (window.location.port ? ":" + window.location.port : ""), o.indexOf(s) > -1 && (o = o.replace(s + "/", "")), o);
        return function(t) {
          return !!t && 0 === window.location.href.indexOf(t);
        }(c) && (u = "(inline script)"), { abs_path: e, filename: u, function: a, lineno: n, colno: r };
      }));
    }

    var vt = [["#", "hash"], ["?", "query"], ["/", "path"], ["@", "auth", 1], [NaN, "host", void 0, 1]],
      ht = /^([a-z][a-z0-9.+-]*:)?(\/\/)?([\S\s]*)/i, gt = function() {
        function t(t) {
          var e, n = this.extractProtocol(t || ""), r = n.protocol, i = n.address, a = n.slashes, o = !r && !a,
            s = this.getLocation(), c = vt.slice();
          ...
          if (o && "/" !== this.path.charAt(0) && (this.path = "/" + this.path), this.relative = o, this.protocol = r || s.protocol, this.hostname = this.host, this.port = "", /:\d+$/.test(this.host)) {
            var h = this.host.split(":"), g = h.pop(), m = h.join(":");
            !function(t, e) {
              switch (e) {
                case"http:":
                  return "80" === t;
    ...
    function yt(t) {
      var e = {
        ...
        for (var e = [], n = 0; n < t.length; n++) {
          var r = t[n], i = r.name, a = r.duration, o = r.description, s = i;
    ...
    function St(t) {
      var e = t.port, n = t.protocol, r = t.hostname, i = function(t, e) {
        return "" === t && (t = "http:" === e ? "80" : "https:" === e ? "443" : ""), t;
      }(e, n), a = 91 === r.charCodeAt(0) && 93 === r.charCodeAt(r.length - 1), o = r;
      return a && (o = r.slice(1, -1)), {
    ...
    function bt(t, e) {
      if (e) {
        ...
        switch (t.type) {
          case"external":
            n = function(t) {
              var e, n = t.url, r = t.method, i = t.target, a = t.response, o = new gt(n), s = St(o),
          ...
          case"resource":
            n = function(t) {
              var e = t.entry, n = t.url, r = St(new gt(n));
    ...
    function wt(t, e) {
      var n = void 0 === e ? {} : e, r = (n.tags, function(t, e) {
        if (null == t) return {};
        var n, r, i = {}, a = Object.keys(t);
        for (r = 0; r < a.length; r++) n = a[r], e.indexOf(n) >= 0 || (i[n] = t[n]);
        return i;
      }(n, mt)), i = _t(), a = {};
      if ("page-exit" === t.type) t.ensureContext(), t.context.page && t.context.page.url && (i.page.url = t.context.page.url); else if (t.type === K && U()) {
    ...
    function Ot(t, e, n) {
      var r = function(t, e, n, r) {
        return void 0 === e && (e = 1024), void 0 === n && (n = !1), void 0 === r && (r = "N/A"), n && Lt(t) && (t = r), "string" == typeof t ? t.substring(0, e) : t;
      }(t[e], n[0], n[1]);
    ...
    var jt = n(816), Rt = n.n(jt), qt = ["tags"];
    ...
    var At = function() {
      ...
      return e.createErrorDataModel = function(t) {
        var e = function(t) {
          return t.filter((function(t) {
            var e = t.filename, n = t.lineno;
            return void 0 !== e && void 0 !== n;
          }));
        }(pt(Rt(), t)), n = "(inline script)", r = e[e.length - 1];
        r && r.filename && (n = r.filename);
        var i = t.message, a = t.error, o = i, s = "", c = {};
        ...
        var f = this._transactionService.getCurrentTransaction(), d = f ? f.context : {},
          l = this._configService.get("context"), p = (l.tags, function(t, e) {
            if (null == t) return {};
            var n, r, i = {}, a = Object.keys(t);
            for (r = 0; r < a.length; r++) n = a[r], e.indexOf(n) >= 0 || (i[n] = t[n]);
            return i;
        ...
        var e, n = t.reason;
        (null == n && (n = "<no reason specified>"), "string" == typeof n.message) ? e = {
          error: n,
        ...
        if (Array.isArray(t)) e.message += "<object>"; else if ("object" == typeof t) try {
      ...
      return e._setTimer = function() {
        ...
        this.items.push(t), -1 !== this.queueLimit && this.items.length >= this.queueLimit ? this.flush() : void 0 === this.timeoutId && this._setTimer();
      }, t;
    }();
    var Mt = function() {
        function t() {
      ...
      Ht = ["fetchStart", "domainLookupStart", "domainLookupEnd", "connectStart", "connectEnd", "requestStart", "responseStart", "responseEnd", "domLoading", "domInteractive", "domContentLoadedEventStart", "domContentLoadedEventEnd", "domComplete", "loadEventStart", "loadEventEnd"],
      Ut = ["fs", "ls", "le", "cs", "ce", "qs", "rs", "re", "dl", "di", "ds", "de", "dc", "es", "ee"];

    function zt(t) {
      var e = function(t) {
        var e = t.redirectStart, n = t.fetchStart, r = t.navigationStart, i = t.responseStart, a = t.responseEnd;
        if (n >= r && i >= n && a >= i) {
          var o = {};
    ...
    function Bt(t) {
      if (!t) return null;
      var e = {}, n = t.page, r = t.http, i = t.response, a = t.destination, o = t.user, s = t.custom;
      if (n && (e.p = { rf: n.referer, url: n.url }), r && (e.h = function(t) {
        var e = {}, n = t.method, r = t.status_code, i = t.url, a = t.response;
    ...
    function Vt(t) {
      ...
      var e = function(t) {
        if (!t) return null;
        var e = {};
        return Ut.forEach((function(n, r) {
          var i = Ht[r];
          e[n] = t[i];
        })), e;
      }(t.navigationTiming);
    ...
    function $t(t, e) {
      ...
      if (t && (n = { fb: t.rs, di: t.di, dc: t.dc }), e) {
        var r = e.firstContentfulPaint, i = e.largestContentfulPaint;
        r && (n.fp = r), i && (n.lp = i);
      }
    ...
    function Jt(t, e) {
      ...
      return new v((function(r) {
        ...
        var i = t.payload, a = t.headers, o = t.beforeSend,
    ...
    function Xt(t, e, n) {
      var r = n.timeout, i = void 0 === r ? HTTP_REQUEST_TIMEOUT : r, a = n.payload, o = n.headers, s = n.beforeSend,
        c = n.sendCredentials;
      return new v((function(n, r) {
        var u = new window.XMLHttpRequest;
        if (u[X] = !0, u.open(t, e, !0), u.timeout = i, u.withCredentials = c, o) for (var f in o) o.hasOwnProperty(f) && u.setRequestHeader(f, o[f]);
        u.onreadystatechange = function() {
          if (4 === u.readyState) {
            var t = u.status, i = u.responseText;
            nt(t) ? n(u) : r({ url: e, status: t, responseText: i });
          }
        }, u.onerror = function() {
          var t = u.status, n = u.responseText;
    ...
    var Gt = function() {
      ...
      return e.init = function() {
        var t = this, e = this._configService.get("queueLimit"), n = this._configService.get("flushInterval"),
          r = this._configService.get("eventsLimit");
        this.queue = new Pt((function(e) {
          var n = t.sendEvents(e);
          n && n.catch((function(e) {
            t._loggingService.warn("Failed sending events!", t._constructError(e));
          }));
        }), { queueLimit: e, flushInterval: n }), this.throttleEvents = function(t, e, n) {
          var r, i = this, a = n.limit, o = n.interval, s = 0;
          return function() {
            return s++, void 0 === r && (r = setTimeout((function() {
              s = 0, r = void 0;
            }), o)), s > a && "function" == typeof e ? e.apply(i, arguments) : t.apply(i, arguments);
          };
        }(this.queue.add.bind(this.queue), (function() {
          return t._loggingService.warn("Dropped events due to throttling!");
        }), { limit: r, interval: 6e4 }), this._configService.observeEvent("queue:flush", (function() {
          t.queue.flush();
        }));
        ...
        var e = t.url, n = t.status;
        t.responseText;
        if (void 0 === n) return t;
        var r = e + " HTTP status: " + n;
        return new Error(r);
      }, e._makeHttpRequest = function(t, e, n) {
        var r = void 0 === n ? {} : n, i = r.timeout, a = void 0 === i ? 1e4 : i, o = r.payload, s = r.headers,
          c = r.beforeSend, u = this._configService.get("sendCredentials");
        return !c && it(t, o) ? function(t, e, n) {
          var r, i = n.keepalive, a = void 0 !== i && i, o = n.timeout, s = void 0 === o ? 1e4 : o, c = n.payload,
            u = n.headers, f = n.sendCredentials, d = {};
          if ("function" == typeof AbortController) {
            var l = new AbortController;
            d.signal = l.signal, setTimeout((function() {
              return l.abort();
            }), s);
          }
          return window.fetch(e, rt({
            body: c,
            headers: u,
            method: t,
            keepalive: a,
          ...
          if (n instanceof TypeError) return Xt(t, e, {
            timeout: a,
            payload: o,
            headers: s,
            beforeSend: c,
        ...
        var n = this, r = this.getEndpoints().configEndpoint;
        ...
        return this._makeHttpRequest("GET", r, { timeout: 5e3, beforeSend: a }).then((function(t) {
          var e = t.status, r = t.responseText;
          if (304 === e) return i;
          var a = JSON.parse(r), o = t.getResponseHeader("etag");
        ...
        return t.map((function(t) {
          var r;
          return Mt.stringify(((r = {})[n] = e ? function(t) {
            var e, n = t.exception, r = {
              id: t.id, cl: t.culprit, ex: {
                mg: n.message, st: (e = n.stacktrace, e.map((function(t) {
        ...
        var n = this, r = e ? "x" : "transaction";
        return t.map((function(t) {
          var i, a = "", o = "";
          return e || (t.spans && (a = t.spans.map((function(t) {
            return Mt.stringify({ span: t });
          })).join(""), delete t.spans), t.breakdown && (o = n.ndjsonMetricsets(t.breakdown), delete t.breakdown)), Mt.stringify(((i = {})[r] = e ? function(t) {
            var e, n = t.spans.map((function(e) {
              ...
              me: (e = t.breakdown, e.map((function(t) {
                var e = t.span, n = t.samples;
                return {
                  y: { t: e.type },
                  sa: { ysc: { v: n["span.self_time.count"].value }, yss: { v: n["span.self_time.sum.us"].value } }
                };
              }))),
              y: n,
              yc: { sd: n.length },
            ...
            if (t.experience) {
              var i = t.experience, a = i.cls, o = i.fid, s = i.tbt, c = i.longtask;
              r.exp = { cls: a, fid: o, tbt: s, lt: c };
            }
            if (t.session) {
              var u = t.session, f = u.id, d = u.sequence;
              r.ses = { id: f, seq: d };
            }
            return r;
          }(t) : t, i)) + a + o;
        ...
        if (0 !== t.length) {
          ...
          if (0 !== r.length || 0 !== i.length) {
            var s = this._configService, c = ((e = {}).transactions = r, e.errors = i, e), u = s.applyFilters(c);
            if (u) {
              var f = s.get("apiVersion") > 2, d = [], l = this.createMetaData(), p = f ? "m" : "metadata";
              d.push(Mt.stringify(((n = {})[p] = f ? function(t) {
                var e = t.service, n = t.labels, r = e.agent, i = e.language;
                return {
                  se: {
                    n: e.name,
                    ve: e.version,
              ...
              var v = (d = d.concat(this.ndjsonErrors(u.errors, f), this.ndjsonTransactions(u.transactions, f))).join(""),
        ...
        var t = this._configService.get("serverUrl"), e = this._configService.get("apiVersion");
        return {
    ...
    var Yt, Qt = function() {
      function t() {
        this.config = {
          ...
          apmRequest: null,
          sendCredentials: !1
        }, this.events = new ot, this.filters = [], this.version = "";
      }
      ...
      return e.init = function() {
        ...
        void 0 === t && (t = {});
        var e = {}, n = t, r = n.id, i = n.username, a = n.email;
        "number" != typeof r && "string" != typeof r || (e.id = r), "string" == typeof i && (e.username = i), "string" == typeof a && (e.email = a), this.config.context.user = O(this.config.context.user || {}, e);
        ...
        void 0 === t && (t = {});
        var e = t, n = e.transactionSampleRate, r = e.serverUrl;
        r && (t.serverUrl = r.replace(/\/+$/, "")), j(n) || (n < 1e-4 && n > 0 && (n = 1e-4), t.transactionSampleRate = Math.round(1e4 * n) / 1e4), N(this.config, t), this.events.send("config:change", [this.config]);
      }, e.validate = function(t) {
        void 0 === t && (t = {});
        var e = ["serviceName", "serverUrl"], n = Object.keys(this.config),
          r = { missing: [], invalid: [], unknown: [] };
        Object.keys(t).forEach((function(i) {
          -1 === e.indexOf(i) || t[i] || r.missing.push(i), -1 === n.indexOf(i) && r.unknown.push(i);
        })), t.serviceName && !/^[a-zA-Z0-9 _-]+$/.test(t.serviceName) && r.invalid.push({
          key: "serviceName",
          value: t.serviceName,
    ...
    }(), Kt = ((Yt = {}).ConfigService = function() {
      return new Qt;
    }, Yt.LoggingService = function() {
      return new Wt({ prefix: "[Elastic APM] " });
    }, Yt.ApmServer = function(t) {
      var e = t.getService(["ConfigService", "LoggingService"]), n = e[0], r = e[1];
      return new Gt(n, r);
    }, Yt), te = function() {
      function t() {
      ...
      return e.init = function() {
        if (!this.initialized) {
          ...
          t.init();
          var e = this.getService(["LoggingService", "ApmServer"]), n = e[0], r = e[1];
        ...
        var e = this;
        return "string" == typeof t ? (this.instances[t] || "function" == typeof Kt[t] && (this.instances[t] = Kt[t](this)), this.instances[t]) : Array.isArray(t) ? t.map((function(t) {
    ...
    var ee = function() {
      ...
      return e.init = function(t) {
        ...
        })), t.history && st.observe("history", this.getHistorySub()), t.xmlhttprequest && st.observe("xmlhttprequest", this.getXHRSub()), t.fetch && st.observe("fetch", this.getFetchSub());
      }, e.getHistorySub = function() {
        var t = this._transactionService;
        return function(e, n) {
          "history" === n.source && e === Q && t.startTransaction(n.data.title, "route-change", {
            managed: !0,
            canReuse: !0
          });
        };
        ...
        var n = this._configService, r = this._transactionService;
        ...
        if ("schedule" === t && e.data) {
          var a = e.data, o = new gt(a.url), s = a.method + " " + (o.relative ? o.path : k(o.href));
          r.getCurrentTransaction() || r.startTransaction(s, "http-request", { managed: !0 });
          var c = r.startSpan(s, "external.http", { blocking: !0 });
          if (!c) return;
          var u = n.get("distributedTracing"), f = n.get("distributedTracingOrigins"), d = new gt(window.location.href),
            l = T(o.origin, d.origin) || T(o.origin, f), p = a.target;
          if (u && l && p) this.injectDtHeader(c, p), n.get("propagateTracestate") && this.injectTSHeader(c, p); else 0;
          a.sync && (c.sync = a.sync), a.span = c;
        } else if (t === Q) {
          var v = e.data;
          if (v && v.span) {
            var h, g, m = v.span, y = v.response, S = v.target;
            h = y ? y.status : S.status, g = "abort" == v.status || v.aborted ? "unknown" : h >= 400 || 0 == h ? "failure" : "success", m.outcome = g;
        ...
        var n, r = this._configService.get("distributedTracingHeaderName"), i = function(t) {
          if (t && t.traceId && t.id && t.parentId) {
            var e = t.sampled ? "01" : "00", n = t.sampled ? t.id : t.parentId;
            return "00-" + t.traceId + "-" + n + "-" + e;
          }
        }(t);
        /^[\da-f]{2}-[\da-f]{32}-[\da-f]{16}-[\da-f]{2}$/.test(n = i) && "00000000000000000000000000000000" !== n.slice(3, 35) && "0000000000000000" !== n.slice(36, 52) && i && r && w(e, r, i);
        ...
        var e = t._start, n = t.spans.map((function(n) {
          var r = {
            id: n.id,
            transaction_id: t.id,
      ...
      function t(t, e, n) {
        void 0 === n && (n = {}), t || (t = "Unknown"), e || (e = "custom"), this.name = t, this.type = e, this.options = n, this.id = n.id || b(16), this.traceId = n.traceId, this.sampled = n.sampled, this.sampleRate = n.sampleRate, this.timestamp = n.timestamp, this._start = P(n.startTime), this._end = void 0, this.ended = !1, this.outcome = void 0, this.onEnd = n.onEnd;
      }
    ...
    var ie = function(t) {
        ...
        return n = t, (e = r).prototype = Object.create(n.prototype), e.prototype.constructor = e, re(e, n), r.prototype.end = function(e, n) {
          t.prototype.end.call(this, e), bt(this, n);
        }, r;
      }(ne),
      ae = [["domainLookupStart", "domainLookupEnd", "DNS"], ["connectStart", "connectEnd", "TCP"], ["requestStart", "responseStart", "Request"], ["responseStart", "responseEnd", "Response"], ["domLoading", "domComplete", "Processing"], ["loadEventStart", "loadEventEnd", "Load"]];
    ...
    function se(t, e) {
      var n = e.details, r = e.count, i = void 0 === r ? 1 : r, a = e.duration;
      return {
        transaction: t,
        span: n,
    ...
    var ue = function(t) {
      ...
      function r(e, n, r) {
        var i;
        return (i = t.call(this, e, n, r) || this).traceId = b(), i.marks = void 0, i.spans = [], i._activeSpans = {}, i._activeTasks = new Set, i.blocked = !1, i.captureTimings = !1, i.breakdownTimings = [], i.sampleRate = i.options.transactionSampleRate, i.sampled = Math.random() <= i.sampleRate, i;
      }
      ...
      return i.addMarks = function(t) {
        ...
        t && (this.name = t), e && (this.type = e), n && (this.options.reuseThreshold = n.reuseThreshold, O(this.options, n));
        ...
        if (!this.ended) {
          ...
          i.onEnd = function(t) {
            r._onSpanEnd(t);
          }, i.traceId = this.traceId, i.sampled = this.sampled, i.sampleRate = this.sampleRate, i.parentId || (i.parentId = this.id);
          var a = new ie(t, e, i);
        ...
        this.breakdownTimings = function(t, e) {
          void 0 === e && (e = m.timing);
          var n = [], r = t.name, i = t.type, a = t.sampled, o = { name: r, type: i };
          if (!a) return n;
          if (i === K && e) for (var s = 0; s < ae.length; s++) {
            var c = ae[s], u = M(e[c[0]], e[c[1]]);
            0 !== u && null != u && n.push(se(o, { details: { type: c[2] }, duration: u }));
          } else {
            var f = function(t) {
              var e = {}, n = function(t) {
                var e = t.spans, n = t._start, r = t._end;
                if (0 === e.length) return t.duration();
                e.sort((function(t, e) {
                  return t._start - e._start;
                }));
                for (var i = e[0], a = i._end, o = i._start, s = a, c = o - n, u = 1; u < e.length; u++) o = (i = e[u])._start, a = i._end, o > s ? (c += o - s, s = a) : a > s && (s = a);
                return s < r && (c += r - s), c;
              }(t);
              e.app = { count: 1, duration: n };
              for (var r = t.spans, i = 0; i < r.length; i++) {
                var a = r[i], o = a.duration();
                if (0 !== o && null != o) {
                  var s = a.type, c = a.subtype, u = s.replace(".truncated", "");
                  c && (u += "." + c), e[u] || (e[u] = { duration: 0, count: 0 }), e[u].count++, e[u].duration += o;
                }
              }
              return e;
            }(t);
            Object.keys(f).forEach((function(t) {
              var e = t.split("."), r = e[0], i = e[1], a = f[t], s = a.duration, c = a.count;
    ...
    function le(t, e) {
      var n = e.isHardNavigation, r = e.trStart, i = t.getEntriesByType("longtask").filter((function(t) {
        return t.startTime >= r;
      })), a = {
        spans: function(t, e) {
          for (var n = [], r = 0; r < t.length; r++) {
            var i = t[r], a = i.name, o = i.startTime, s = i.duration, c = i.attribution, u = o + s,
              f = new ie("Longtask(" + a + ")", "longtask", { startTime: o });
            if (e.count++, e.duration += s, e.max = Math.max(s, e.max), c.length > 0) {
              var d = c[0], l = d.name, p = d.containerType, v = d.containerName, h = d.containerId,
      ...
      if (!n) return a;
      var o = t.getEntriesByType("largest-contentful-paint"), s = o[o.length - 1];
      if (s) {
        var c = parseInt(s.startTime);
        de.lcp = c, a.marks.largestContentfulPaint = c;
      }
      var u = m.timing, f = u.fetchStart - u.navigationStart;
      B(u) && (f = 0);
      ...
      var p = function(t) {
        var e = t[0];
        if (e) {
          var n = e.startTime, r = e.processingStart, i = new ie("First Input Delay", "first-input", { startTime: n });
          return i.end(r), i;
        }
      }(t.getEntriesByType("first-input"));
      return p && (de.fid = p.duration(), a.spans.push(p)), function(t) {
        t.forEach((function(t) {
          var e = t.name, n = t.startTime, r = t.duration;
        ...
        t.forEach((function(t) {
          !t.hadRecentInput && t.value && ((t.startTime - de.cls.firstEntryTime > 5e3 || t.startTime - de.cls.prevEntryTime > 1e3) && (de.cls.firstEntryTime = t.startTime, de.cls.currentSessionScore = 0), de.cls.prevEntryTime = t.startTime, de.cls.currentSessionScore += t.value, de.cls.score = Math.max(de.cls.score, de.cls.currentSessionScore));
        }));
      }(t.getEntriesByType("layout-shift")), a;
    }

    var pe = function() {
      function t(t) {
        this.po = { observe: R, disconnect: R }, window.PerformanceObserver && (this.po = new PerformanceObserver(t));
      }
    ...
    function ve(t, e, n, r, i) {
      return void 0 === i && (i = 0), "number" == typeof t && "number" == typeof e && t >= i && e > t && t - i >= n && e - i <= r && e - t < 3e5 && t - i < 3e5 && e - i < 3e5;
    }

    var he = [["redirectStart", "redirectEnd", "Redirect"], ["domainLookupStart", "domainLookupEnd", "Domain lookup"], ["connectStart", "connectEnd", "Making a connection to the server"], ["requestStart", "responseEnd", "Requesting and receiving the document"], ["domLoading", "domInteractive", "Parsing the document, executing sync. scripts"], ["domContentLoadedEventStart", "domContentLoadedEventEnd", "Fire \"DOMContentLoaded\" event"], ["loadEventStart", "loadEventEnd", "Fire \"load\" event"]];

    function ge(t) {
      var e = t.name, n = t.initiatorType, r = t.startTime, i = t.responseEnd, a = "resource";
      n && (a += "." + n);
      var o = k(e), s = new ie(o, a);
        ...
        if (t.type === K) {
          ...
          (function(t, e, n, r) {
            for (var i = [], a = 0; a < he.length; a++) {
              var o = t[he[a][0]], s = t[he[a][1]];
              if (ve(o, s, n, r, e)) {
                var c = new ie(he[a][2], "hard-navigation.browser-timing"), u = null;
                "requestStart" === he[a][0] && (c.pageResponse = !0, u = { url: location.origin }), c._start = o - e, c.end(s - e, u), i.push(c);
              }
            }
            return i;
        ...
        if (U()) {
          ...
          (function(t, e, n, r) {
            for (var i = [], a = 0; a < t.length; a++) {
              var o = t[a], s = o.initiatorType, c = o.name, u = o.startTime, f = o.responseEnd;
              -1 !== W.indexOf(s) && null != c && (("xmlhttprequest" === s || "fetch" === s) && (/intake\/v\d+\/rum\/events/.test(c) || me(u, e)) || ve(u, f, n, r) && i.push(ge(t[a])));
            }
            return i;
            ...
            for (var r = [], i = 0; i < t.length; i++) {
              var a = t[i], o = a.name, s = a.startTime, c = a.duration, u = s + c;
              if (!(c <= 60) && ve(s, u, e, n)) {
                var f = new ie(o, "app");
    ...
    var Se = function() {
      function t(t, e) {
        var n = this;
        this._config = e, this._logger = t, this.currentTransaction = void 0, this.respIntervalId = void 0, this.recorder = new pe((function(t) {
          var e = n.getCurrentTransaction();
          if (e && e.captureTimings) {
            var r, i = e.type === K, a = le(t, { isHardNavigation: i, trStart: i ? 0 : e._start }), o = a.spans,
              s = a.marks;
      ...
      return e.createCurrentTransaction = function(t, e, n) {
        ...
        var e = this._config.config, n = O({ transactionSampleRate: e.transactionSampleRate }, t);
        return n.managed && (n = O({
        ...
        var r = this.getCurrentTransaction(), i = !1;
        if (r) if (r.canReuse() && n.canReuse) {
          var a = r.type, o = tt.indexOf(r.type), s = tt.indexOf(e);
          o >= 0 && s < o && (a = e), r.redefine(t, a, n), i = !0;
        } else r.end(), r = this.createCurrentTransaction(t, e, n); else r = this.createCurrentTransaction(t, e, n);
        ...
        a.managed ? this.currentTransaction === (r = this.startManagedTransaction(t, e, a)) && (o = !1) : r = new ue(t, e, a);
        return r.onEnd = function() {
          return i.handleTransactionEnd(r);
        }, o && this._config.events.send("transaction:start", [r]), r;
      }, e.handleTransactionEnd = function(t) {
        var e = this;
        this.recorder.stop();
        var n = window.location.href;
        return v.resolve().then((function() {
          var r = t.name, i = t.type;
          if (ft.lastHiddenStart >= t._start) e._config.dispatchEvent("transaction:ignore"); else if (e.shouldIgnoreTransaction(r) || "temporary" === i) e._config.dispatchEvent("transaction:ignore"); else {
            if (i === K) {
              var a = e._config.get("pageLoadTransactionName");
              if ("Unknown" === r && a && (t.name = a), t.captureTimings) {
                var o = de.cls, s = de.fid, c = de.tbt, u = de.longtask;
                c.duration > 0 && t.spans.push((d = (f = c).start, l = f.duration, (p = new ie("Total Blocking Time", "longtask", { startTime: d })).end(d + l), p)), t.experience = {}, z("longtask") && (t.experience.tbt = c.duration), z("layout-shift") && (t.experience.cls = o.score), s > 0 && (t.experience.fid = s), u.count > 0 && (t.experience.longtask = {
                  count: u.count,
                  sum: u.duration,
                  max: u.max
                });
            ...
            "Unknown" === t.name && (t.name = function(t, e) {
              void 0 === e && (e = 2);
              for (var n = new gt(t), r = n.query, i = n.path.substring(1).split("/"), a = /\W|_/g, o = /[0-9]/g, s = /[a-z]/g, c = /[A-Z]/g, u = [], f = !1, d = 0; d < i.length; d++) {
                var l = i[d];
                if (f || d > e - 1) {
                  l && u.push("*");
                  break;
                }
                if ((l.match(a) || []).length >= 2) u.push(":id"), f = !0; else {
                  var p = (l.match(o) || []).length;
                  if (p > 3 || l.length > 3 && p / l.length >= .3) u.push(":id"), f = !0; else {
                    var v = (l.match(c) || []).length, h = (l.match(s) || []).length / l.length, g = v / l.length;
                    l.length > 5 && (g > .3 && g < .6 || h > .3 && h < .6) ? (u.push(":id"), f = !0) : l && u.push(l);
                  }
                }
              }
              return "/" + (u.length >= 2 ? u.join("/") : u.join("")) + (r ? "?{query}" : "");
            }(n)), ye(t), e.adjustTransactionTime(t), e._config.get("breakdownMetrics") && t.captureBreakdown();
        ...
        if (t.type === K) {
          var i = t._end - 1e3, a = de.lcp || 0, o = (function(t) {
            return F(t, (function(t) {
              return -1 !== String(t).indexOf("external");
            }));
          }(e) || {})._end || 0;
    ...
    function _e() {
      return Kt.TransactionService = function(t) {
        var e = t.getService(["LoggingService", "ConfigService"]), n = e[0], r = e[1];
        return new Se(n, r);
      }, Kt.PerformanceMonitoring = function(t) {
        var e = t.getService(["ApmServer", "ConfigService", "LoggingService", "TransactionService"]), n = e[0],
          r = e[1], i = e[2], a = e[3];
        return new ee(n, r, i, a);
      }, Kt.ErrorLogging = function(t) {
        var e = t.getService(["ApmServer", "ConfigService", "TransactionService"]), n = e[0], r = e[1], i = e[2];
        return new At(n, r, i);
      }, new te;
    }
    ...
    function we(t) {
      t.getEntries().forEach((function(t) {
        t.interactionId && (function(t) {
          if (D()) return;
          be.minInteractionId = Math.min(be.minInteractionId, t.interactionId), be.maxInteractionId = Math.max(be.maxInteractionId, t.interactionId), be.interactionCount = (be.maxInteractionId - be.minInteractionId) / 7 + 1;
        }(t), t.duration < 40 || function(t) {
    ...
    function Ee(t) {
      ...
      if (e >= 0) {
        var n = A(), r = t.startTransaction("page-exit", "page-exit", { startTime: n }),
        ...
        var o = n + e + 1;
        return r.end(o), be.minInteractionId = 1 / 0, be.maxInteractionId = 0, be.interactionCount = 0, be.longestInteractions = [], r;
      }
    }

    function xe(t, e) {
      if (Ee(e)) var n = t.observeEvent("queue:add_transaction", (function() {
        ke(t, e), n();
      })); else ke(t, e);
    }
    ...
    function Ie(t) {
      var e = function(e) {
        e.target instanceof Element && function(t, e) {
          var n = function(t) {
            ...
            e.transactionName = function(t) {
              var e = function(t) {
                ...
                if (t.closest) {
                  var n = t.closest("a[data-transaction-name], button[data-transaction-name]");
                  return n ? n.getAttribute("data-transaction-name") : e;
                }
                return e;
              }(t);
              if (e) return e;
              var n = t.tagName.toLowerCase(), r = t.getAttribute("name");
              if (r) return n + "[\"" + r + "\"]";
              return n;
            }(t);
            ...
            return e;
          }(e), r = n.transactionName, i = n.context, a = t.startTransaction("Click - " + r, "user-interaction", {
            managed: !0,
            canReuse: !0,
            reuseThreshold: 300
          });
      ...
      return window.addEventListener("click", e, !0), function() {
    ...
    var Ce = function() {
      ...
      return e.isEnabled = function() {
        ...
        if (this.isEnabled() && !this._initialized) {
          this._initialized = !0;
          var n = this.serviceFactory.getService(["ConfigService", "LoggingService", "TransactionService"]), r = n[0],
            i = n[1], a = n[2];
          r.setVersion("5.16.1"), this.config(t);
          var o = r.get("logLevel");
          if (i.setLevel(o), r.get("active")) {
            this.serviceFactory.init();
            var s = function(t, e) {
              var n,
                r = ((n = {}).xmlhttprequest = !1, n.fetch = !1, n.history = !1, n[K] = !1, n.error = !1, n.eventtarget = !1, n.click = !1, n);
              return t ? (Object.keys(r).forEach((function(t) {
                -1 === e.indexOf(t) && (r[t] = !0);
              })), r) : r;
            }(r.get("instrument"), r.get("disableInstrumentations"));
            if (this.serviceFactory.getService("PerformanceMonitoring").init(s), s.error) this.serviceFactory.getService("ErrorLogging").registerListeners();
            if (r.get("session")) {
            ...
            r.get("centralConfig") ? this.fetchCentralConfig().then(u) : u(), function(t, e) {
            ...
            }(r, a), s.eventtarget && s.click && Ie(a), function(t) {
        ...
        var t = this.serviceFactory.getService(["ApmServer", "LoggingService", "ConfigService"]), e = t[0], n = t[1],
          r = t[2];
        return e.fetchConfig(r.get("serviceName"), r.get("environment")).then((function(t) {
          var e = t.transaction_sample_rate;
          if (e) {
            var i = { transactionSampleRate: e = Number(e) }, a = r.validate(i).invalid;
            if (0 === a.length) r.setConfig(i); else {
              var o = a[0], s = o.key, c = o.value, u = o.allowed;
        ...
        var e = this.serviceFactory.getService(["ConfigService", "LoggingService"]), n = e[0], r = e[1],
          i = n.validate(t), a = i.missing, o = i.invalid, s = i.unknown;
        if (s.length > 0) {
          var c = "Unknown config options are specified for RUM agent: " + s.join(", ");
          r.warn(c);
        }
        if (0 === a.length && 0 === o.length) n.setConfig(t); else {
          var u = "RUM agent isn't correctly configured. ";
          a.length > 0 && (u += a.join(", ") + " is missing", o.length > 0 && (u += ", ")), o.forEach((function(t, e) {
            var n = t.key, r = t.value, i = t.allowed;
            u += n + " \"" + r + "\" contains invalid characters! (allowed: " + i + ")" + (e !== o.length - 1 ? ", " : "");
          })), r.error(u), n.setConfig({ active: !1 });
        }
      }, e.setUserContext = function(t) {
