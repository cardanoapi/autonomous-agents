...
agent_instance_wallet_repository = AgentInstanceWalletRepository()


# Services
kafka_service = KafkaService()
agent_instance_wallet_service = AgentInstanceWalletService(agent_instance_wallet_repository)
