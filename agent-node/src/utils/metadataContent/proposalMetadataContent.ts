export function generateProposalMetadataContent(agentName: string) {
    return JSON.stringify({
        ...
        body: {
            ...
            motivation: 'This proposal is automatically generated by autonomous-agent-testing.',
            references: [
                {
                    '@type': 'Other',
            ...
            rationale: 'This proposal was created as a part of testing for autonomous-agent-testing',
        },
    })
}
